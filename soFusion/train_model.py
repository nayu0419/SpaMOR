...
def train(adatalist, adj, sequencing=["unknown", "unknown"], k=10, h=[1000, 1000], n_epochs=200, lr=0.0001,
          key_added='soFusion', random_seed=0, l=1, weight_decay=0.0001, a=10, b=100, c=10, d=1, embed=True,
    ...
    model = models.soFusion(nfeatX=features1.shape[1],
