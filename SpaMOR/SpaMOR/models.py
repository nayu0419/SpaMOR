...
import numpy as np
import scanpy as sc
from SpaMOR.utils import ZINB
from SpaMOR.layers import GraphConvolution,SelfAttention,MLP,MGCN,ZINBDecoder,Omics_label_Predictor,MixtureNBLogNormal,BernoulliDecoder,Decoder
import sys

import torch
import torch.nn as nn

class SpaMOR(nn.Module):
    def __init__(self, nfeatX, nfeatI, hidden_dims, sequencing, weights):
        super(SpaMOR, self).__init__()
